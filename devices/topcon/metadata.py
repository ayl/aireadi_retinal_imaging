...
def meta_data_save(filename, output_folder):
    ...
    if dataset.SOPClassUID == "1.2.840.10008.5.1.4.1.1.77.1.5.7":
        ...
        if len(dataset["00221627"].value) == 1:
            layer1 = dataset["00221627"][0]["0008114C"][0]["0062000F"][0][
                "00080104"
            ].value
            layer2 = ""

        elif len(dataset["00221627"].value) == 2:
            layer1 = dataset["00221627"][0]["0008114C"][0]["0062000F"][0][
                "00080104"
            ].value
            layer2 = dataset["00221627"][1]["0008114C"][0]["0062000F"][0][
                "00080104"
            ].value
