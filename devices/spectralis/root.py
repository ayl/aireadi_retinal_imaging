...
from . import organize as spectralis_organize
...
class Spectralis(DataDomain):
    ...
    def octa_convert(self, input_dicom_file, output):
        """
        Converts a OCTA DICOM file to a NEMA compliant *.dcm file.
        ...
        Returns:
            dict: A dictionary containing information on conversion issues and output files.
        """
        conv_dict = spectralis_conv.convert_octa_dicom(input_dicom_file, output)
