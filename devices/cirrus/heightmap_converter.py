...
import numpy as np
import pydicom
from .heightmap_functional_groups import (
    dimension_index_sequence, dimension_organization_sequence,
    per_frame_functional_groups_sequence, referenced_series_sequence,
    segment_sequence, shared_functional_group_sequence)
...
heightmap = ConversionRule(
    ...
    [
        ...
        Element(
            "SOPClassUID", "00080016", "UI", HARMONIZE, "1.2.840.10008.5.1.4.1.1.66.8"
        ),
...
def extract_dicom_dict(file, tags):
    ...
    header_elements = {
        ...
        "00020002": {"vr": "UI", "Value": ["1.2.840.10008.5.1.4.1.1.66.8"]},
        "00020003": {
            "vr": "UI",
